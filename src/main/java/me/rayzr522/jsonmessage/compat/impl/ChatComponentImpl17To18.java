...
public class ChatComponentImpl17To18 implements ChatComponentCompat {
    private final Constructor<?> chatComponentText;
    private final MethodHandle STRING_TO_CHAT;

    public ChatComponentImpl17To18() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException {
